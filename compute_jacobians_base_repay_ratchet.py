...
if __name__ == "__main__":
    ...
    results_fp = os.path.join(results_dir, 'repay_ratchet_strategy.pkl')
    ...
    if not os.path.exists(results_fp):
        ...
        store_dict = {
            'inputs': {
                ...
                'max_repayment_term_vec': max_repayment_term_vec,
                'max_fee_reward_fraction_vec': max_fee_reward_fraction_vec,
            },
            'outputs': {
